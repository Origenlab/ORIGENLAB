...
| Campo | Valor |
|---|---|
| Nombre clave | **SEGURIDADPRIVADA** |
| Dominio | `seguridad-privada.com.mx` |
| Sector | Seguridad privada |
| Cuenta GitHub | Origenlab |
| Repo / root | `SEGURIDADPRIVADA` |
| Rama activa | `restructure-2026` |
...
| Salud general | 🟡 Atención (score 32) |
...
- [ ] P2 · Optimizar 3 imágenes pesadas (WebP/AVIF <200KB)
- [ ] P3 · Convertir 11 imágenes raster a formatos modernos

## 6. Pronóstico y prioridad

- **Prioridad global:** P2 — Atención
- **Score de severidad:** 32 (más alto = más intervención)
- **Triage:** #18 de 31
