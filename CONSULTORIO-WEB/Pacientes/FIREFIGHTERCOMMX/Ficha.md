...
| Campo | Valor |
|---|---|
| Nombre clave | **FIREFIGHTERCOMMX** |
| Dominio | `firefighter.com.mx` |
| Sector | Contra incendios |
| Cuenta GitHub | Origenlab |
| Repo / root | `FIREFIGHTERCOMMX` |
| Rama activa | `main` |
