...
| Campo | Valor |
|---|---|
| Nombre clave | **GAMADEMEXICO** |
| Dominio | `gamademexico.com` |
| Sector | Contra incendios |
| Cuenta GitHub | Origenlab |
| Repo / root | `GAMADEMEXICO` |
| Rama activa | `main` |
...
- [ ] P3 · Convertir 13 imágenes raster a formatos modernos
