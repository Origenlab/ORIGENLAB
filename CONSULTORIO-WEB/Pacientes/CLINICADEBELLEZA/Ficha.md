...
| Campo | Valor |
|---|---|
| Nombre clave | **CLINICADEBELLEZA** |
| Dominio | `clinicadebelleza.com.mx` |
| Sector | Belleza |
| Cuenta GitHub | Origenlab |
| Repo / root | `CLINICADEBELLEZA` |
| Rama activa | `main` |
