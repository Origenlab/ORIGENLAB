...
| Campo | Valor |
|---|---|
| Nombre clave | **FIREFIGHTERMX** |
| Dominio | `firefighter.mx` |
| Sector | Contra incendios |
| Cuenta GitHub | Origenlab |
| Repo / root | `FIREFIGHTERMX` |
