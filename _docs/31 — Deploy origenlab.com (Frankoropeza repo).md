...
> **Autoridad.** Este documento reemplaza a [[29 — Deploy & GitHub Push (2026-04-21)]] como referencia de deploy a producción. `29` quedó como registro histórico del primer push; este describe el pipeline actual hacia el dominio real `origenlab.com`.
