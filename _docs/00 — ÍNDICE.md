...
> Documentación completa del sitio origenlab.com · Actualizado 2026-04-26
...
- [[31 — Deploy origenlab.com (Frankoropeza repo)]] — **Pipeline definitivo hacia producción** · repo `Frankoropeza/origenlab` · script `_push-origenlab-com.sh` · acceso vía colaborador (sin PAT)
- [[32 — Playbook — Nuevo sitio en GH Pages + Cloudflare]] — Receta genérica para futuros dominios · checklist, errores comunes, multi-cuenta en macOS
